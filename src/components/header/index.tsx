...
export const Header:FC<HeaderProps> = ({ setIsShowLogin }) => {
  ...
  const favoriteBooks = useSelector(getFavoriteBooks) as any[];
        ...
        <div className="header__wrapper">
          ...
          <div className={`header__menu__wrapper ${isMenuOpen ? "open" : ""}`}>
            ...
            {isAuth ? (
              ...
              <>
                <Button title="Sing in" onClick={handleLoginClick} isOutlineButton={false} />
              </>
            )}
          </div>
